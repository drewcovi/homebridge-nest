...
NestThermostatAccessory.prototype.setTargetHeatingCooling = function (targetHeatingCooling, callback) {
  ...
  if(this.device.hvac_mode === 'eco') {
    this.log.debug(this.getCurrentHeatingCooling(), this.getService(Service.Thermostat));
    //this.getService(Service.Thermostat).setCharacteristic(Characteristic.TargetHeatingCoolingState, );
